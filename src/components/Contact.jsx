    ...
    <section id="contact" className="section-spacing relative overflow-hidden">
      ...
      <div className="section-container">
        <motion.div {...fadeUp} className="mb-12 text-center">
          ...
          <p className="mx-auto mb-8 max-w-xl text-body-lg text-surface-500 dark:text-surface-400">
            If you&apos;re building an AI product, modern web platform, or realtime experience, I&apos;d love to hear what you are working on.
          </p>
          <div className="inline-flex items-center gap-2.5 rounded-full bg-accent/[0.08] px-5 py-2.5 text-xs font-semibold text-accent dark:bg-accent/[0.12]">
              ...
              <div className="flex flex-col justify-between border-b border-surface-200 bg-surface-50 p-6 lg:col-span-2 lg:border-b-0 lg:border-r lg:p-8 dark:border-surface-800 dark:bg-surface-800/30">
                ...
                <div className="mt-5 grid grid-cols-2 gap-2">
                  {[
                    ...
                    { value: 'India', label: 'Base Location' },
                  ].map((s) => (
                    <div key={s.label} className="rounded-lg border border-surface-200/60 bg-white px-3 py-2 text-center dark:border-surface-700/50 dark:bg-surface-800/50">
                      <p className="text-xs font-bold text-surface-900 dark:text-white">{s.value}</p>
                      <p className="text-[10px] text-surface-400 dark:text-surface-500">{s.label}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="p-8 lg:col-span-3 lg:p-10">
                ...
                <div className="mb-8 space-y-3">
                  {[
                    ...
                    const inner = (
                      <div className="group flex items-center gap-4 rounded-xl border border-surface-200/80 p-4 transition-colors hover:border-accent/30 dark:border-surface-700/50">
                        <span className="text-surface-400 transition-colors group-hover:text-accent">{item.icon}</span>
                        <div>
          ...
          >
            <div className="flex items-center justify-between border-b border-surface-200 px-6 py-4 dark:border-surface-800">
              ...
              <button
                ...
                className="flex h-8 w-8 items-center justify-center rounded-lg bg-surface-100 transition-colors hover:bg-surface-200 dark:bg-surface-800 dark:hover:bg-surface-700"
              >
            ...
            <iframe src={scheduleCallUrl} title="Schedule" className="h-[calc(100%-56px)] w-full border-0" />
          </div>
        </div>
      )}
    </section>
